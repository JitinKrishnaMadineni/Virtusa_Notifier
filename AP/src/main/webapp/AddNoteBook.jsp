...
<div id="main">
  <span style="font-size:25px;cursor:pointer" onclick="openNav()"><i class="fa fa-bars" style="color:white;">
  </i></span>
<a  id="newnotebook" style="color:white;font-size:20px;float:right;padding:7px 150px;" href="addNoteBook.html" >NEWNOTEBOOK</a>
...
<form class="example" action="/action_page.php" style="margin:auto;max-width:300px">
  <input id="searchbar" onkeyup="search_notes()" type="text"
        name="search" placeholder="Search notebook.."><span><i class="fa fa-search" style='font-size:20px;padding:8px'></i></span>
...
try
{
	...
	{ 
		...
		//session.setAttribute("notebookname",rs.getString("Notebookname"));
			    ...
			    "<li class='note'><a href='notes1.jsp?notebookname="+name+"' style='padding:5px;'>"+rs.getString("Notebookname")+"</a></li>"
			    		 +"<li class='plus'><span><br>.</span>"
			    		+"<a href='deletebook.jsp?notebookname="+name+"' style='float:right;padding:0px 20px;'><b>&times</b>delete</a>"
			    +"<a href='editNoteBook.jsp?notebookname="+name+"' style='float:right;'><i class='fa fa-edit' style='font-size:14px'></i>Edit</a></li>"
			    		+ "</div>"
			    		+ "</div>");
