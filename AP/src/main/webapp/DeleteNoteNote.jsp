...
//out.println(eemail);
//out.println(request.getParameter("notebookname"));
//out.println(request.getParameter("notename"));
if(i>0){
out.println("<script> window.location.assign('notes1.jsp?notebookname="+request.getParameter("notebookname")+"'); </script>");
}
