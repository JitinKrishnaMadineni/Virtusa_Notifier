...
try
{
	...
	out.println("<h4>Remainder</h4>");
	while(rs2.next())
	{ 
		
		out.println("<div >"
			   // +"<div style='background-color:white;float:left;padding:0px 30px;'>"
			    +"<p><a href='DisplayNotes.jsp?notebookname="+rs2.getString("Notename")+"'>"+rs2.getString("Notename")+"</a><br>StartedOn  :" +rs2.getString("Startdate")+"<br>EndsOn    :"+rs2.getString("Enddate")+"</p>"
	...
	{ 
		...
		out.println("<div style='margin:5% 10%;background-color:#F0F3F3;width:80%;height:20px;padding:0px 0px 7px 10px;'>"
			    ...
			    + "<li class='notes'><a href='DisplayNotes.jsp?notebookname="+name+"' style='padding:5px;'>"+rs.getString("Notename")+"</a></li>"
			          +"<li class='plus'><span><br><a href='DashBoardPlus.jsp'><b>+</b></a></span>"
